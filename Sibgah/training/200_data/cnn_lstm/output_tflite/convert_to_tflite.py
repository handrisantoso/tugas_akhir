"""
convert_to_tflite.py ONNX to TFLite conversion for cnn_lstm.

Requirements: Python <= 3.12, tensorflow >= 2.13, onnx2tf
    pip install tensorflow onnx2tf

Google Colab quick-start:
    1. Upload cnn_lstm.onnx to Colab.
...
tflite_path = os.path.join(OUTPUT_DIR, "cnn_lstm_float32.tflite")
...
c_code = (
    "// model_data.h -- cnn_lstm TFLite model\n"
    "#pragma once\n"
