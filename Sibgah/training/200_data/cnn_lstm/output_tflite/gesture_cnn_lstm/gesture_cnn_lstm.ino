/*
 * gesture_cnn_lstm.ino — Gesture detection using CNN-LSTM (TFLite Micro)
 *
 * Required files (copy all into this sketch folder):
 *   model_data.h     — generated by convert_to_tflite.py (run on Colab)
 *   scaler_params.h  — from cnn_lstm/output_tflite/
 *   labels.h         — from cnn_lstm/output_tflite/
 *
 ...
 *
 * Note: LSTM needs more tensor arena than a pure CNN.
 *       Starts at 64 KB — increase if AllocateTensors() fails.
 */
...
void run_inference() {
  ...
  Serial.printf("[CNN-LSTM] Gesture: %s  (%.1f%%)\n",
...
void setup() {
  ...
  static tflite::MicroInterpreter static_interp(
      tfl_model, resolver, tensor_arena, TENSOR_ARENA_SIZE, nullptr);
