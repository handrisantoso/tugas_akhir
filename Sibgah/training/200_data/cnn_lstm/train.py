"""
Phase 3: CNN-LSTM gesture classifier (PyTorch).
Note: TensorFlow does not yet support Python 3.14; PyTorch is used instead.

Architecture: Conv1D(64) -> Conv1D(64) -> LSTM(64) -> Dense(64) -> Softmax
Outputs saved to cnn_lstm/output/:
...
def main() -> None:
    print("=" * 50)
    print("  Phase 3: CNN-LSTM (PyTorch)")
    print("=" * 50)
    ...
    model = CNNLSTM(n_features=X_train.shape[2], num_classes=num_classes)
